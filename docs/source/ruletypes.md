* _Examples:_ [here](/examples/rules)
* "time" formats
  * == `unit: X` /
    * ALLOWED `unit`
      * weeks,
...
| `kibana_discover_app_url` | string | Optional | ❌NO default❌ |
...
| `timestamp_type` | string | Optional | iso |
| `timestamp_format` | string | Optional | "%Y-%m-%dT%H:%M:%SZ" |
| `timestamp_format_expr` | string | Optional | ❌NO default❌ |
| `timestamp_to_datetime_format_expr` | string | Optional | ❌NO default❌ |
| `_source_enabled` | boolean | Optional | True |
| `alert_text_args` | array of strs | Optional | ❌NO default❌ |
| `alert_text_kw` | object | Optional | ❌NO default❌ |
| `alert_missing_value` | string | Optional | "<MISSING VALUE>" |
| `is_enabled` | boolean | Optional | True |
| `search_extra_index` | boolean | Optional | False |
...
|-----------|-----|-----------|-----------|--------|-----------|-------|----------|----------|-------------|-------------------|-------------------|------------------|
| `compare_key` <br/> &nbsp;&nbsp;&nbsp; == list of strs <br/> &nbsp;&nbsp;&nbsp; ❌NO default❌ | | Req | Req | Req | | | | | | | | |
| `blacklist` <br/> &nbsp;&nbsp;&nbsp; == list of strs <br/> &nbsp;&nbsp;&nbsp; ❌NO default❌ | | Req | | | | | | | | | | |
| `whitelist` <br/> &nbsp;&nbsp;&nbsp; == list of strs <br/> &nbsp;&nbsp;&nbsp; ❌NO default❌ | | | Req | | | | | | | | | |
| `ignore_null` <br/> &nbsp;&nbsp;&nbsp; == boolean <br/> &nbsp;&nbsp;&nbsp; by default, `False` | | | Req | Req | | | | | | | | |
| `query_key` <br/> &nbsp;&nbsp;&nbsp; == string or list of strs <br/> &nbsp;&nbsp;&nbsp; ❌NO default❌ | Opt | | | Req | Opt | Opt | Opt | Req | Opt | Opt | Opt | Opt |
...
| `attach_related` <br/> &nbsp;&nbsp;&nbsp; == boolean <br/> &nbsp;&nbsp;&nbsp; by default, `False` | | | | | Opt | | | | | | | |
| `use_count_query` <br/> &nbsp;&nbsp;&nbsp; == boolean <br/> &nbsp;&nbsp;&nbsp; by default, `False` | | | | | Opt | Opt | Opt | | | | | |
| `use_terms_query` <br/> &nbsp;&nbsp;&nbsp; == boolean <br/> &nbsp;&nbsp;&nbsp; by default, `False` | | | | | Opt | Opt | | Opt | | | | |
| `query_key` <br/> &nbsp;&nbsp;&nbsp; == string or list of strs <br/> &nbsp;&nbsp;&nbsp; ❌NO default❌ | | | | | | | | | | | | |
| `terms_size` <br/> &nbsp;&nbsp;&nbsp; == int <br/> &nbsp;&nbsp;&nbsp; by default, 50 | | | | | | | | | | | | |
| `spike_height` (int, no default) | | | | | | Req | | | | | Req | |
| `spike_type` ([up\|down\|both], no default) | | | | | | Req | | | | | Req | |
| `alert_on_new_data` <br/> &nbsp;&nbsp;&nbsp; == boolean <br/> &nbsp;&nbsp;&nbsp; by default, `False` | | | | | | Opt | | | | | | |
...
| `fields` <br/> &nbsp;&nbsp;&nbsp; == string or list of strs <br/> &nbsp;&nbsp;&nbsp; ❌NO default❌ | | | | | | | | Req | | | | |
| `terms_window_size` (time, default 30 days) | | | | | | | | Opt | | | | |
| `window_step_size` (time, default 1 day) | | | | | | | | Opt | | | | |
| `alert_on_missing_field` <br/> &nbsp;&nbsp;&nbsp; == boolean <br/> &nbsp;&nbsp;&nbsp; by default, `False` | | | | | | | | Opt | | | | |
